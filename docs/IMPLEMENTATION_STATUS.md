...
| 2. Test harness              | In progress                           | No-load gates passed in GitHub Actions; the manual three-request protocol smoke remains                     |
...
1. Review the three-request smoke package before any live protocol smoke.
