...
| A ramp cannot run accidentally                      | [Light-ramp workflow](../.github/workflows/gatling-cloud-light-ramp.yml) | [Implementation status](IMPLEMENTATION_STATUS.md)                                           | One-minute duration, literal confirmation, environment gate, and shared concurrency are enforced   |
...
then reduced to one minute while retaining the approved peak rate.
...
| Light-ramp status                | One-minute credit-bounded execution pending         |
